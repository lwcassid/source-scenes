/* ---------- SRC-16.9 · RAIN ATRIUM V9 (the piano breathes with the rain) --
...
reg({
  id: 'SRC-16.9', family: 'SRC-16', ver: 9, title: 'Rain Atrium V9', tech: 'TWO-FIELD WATER / MOTIF RAIN',
  music: {
          ...
          if (idx > lastIdx) {
            ...
            if (gate > 0.03) {
              ...
              if (st === 0) {
                ...
                // legato to the bar; color bar leans on the MINOR THIRD —
                // the hop to the fifth read dopey
                A.bassNote(H.chordTone(bar % 4 === 3 ? 2 : 0, -1), { at: nextT, vol: 0.05 + 0.09 * gate, dur: T.beat * 3.9 });
              }
