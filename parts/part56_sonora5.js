...
reg({
  ...
  step(P, dt, t, inp) {
    ...
    const magL = w * (0.30 + (0.055 - 0.30) * inp.L);   // inp.L 0 → .30w  · 1 → .055w
    const magR = w * (0.70 + (0.945 - 0.70) * inp.R);   // inp.R 0 → .70w  · 1 → .945w
