/* ---------- SRC-10.7 · WEATHER STATION V7 (three streams, wilder length) ---------- */
reg({
  id: 'SRC-10.7', family: 'SRC-10', ver: 8,
  title: 'Weather Station V7', tech: 'ONE FIELD / THREE STREAMS',
  music: { bpm: 60, root: 43, mode: 'aeolian', prog: [0, 5], chordBars: 4 },
  fx: { bloom: 0.65, edge: true },
  tags: ['ONE PARTICLE FIELD', 'THREE STREAMS', 'WILD LENGTH RANGE', 'WHITE, NOT RAINBOW'],
  desc: 'Still one field, same tiny background threads at rest. But raise your right hand now and the wind doesn\'t just thicken evenly — it organizes into three separate streams, each wandering the frame on its own drifting, waving current, each pulling the threads caught inside it toward its own slightly different heading. Where a stream runs, threads stretch — some just a flick, some into huge sweeping strands — into a dense, distinct cluster; between streams, the field stays a scatter of tiny marks. Three currents, three clusters, always shifting.',
  interact: 'L = heading — the whole field snaps to a new direction almost instantly, and a fast turn briefly straightens everything into one aligned sweep. R = the streams: at rest, tiny marks everywhere; raise the hand and three wandering currents pull threads into long, wildly varied strands — flicks next to huge sweeps, in three drifting clusters of density surrounded by empty space.',
