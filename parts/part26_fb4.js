/* ---------- SRC-15.4 · FERRO BLOOM V4 (warm rings, spread garden, sides that feed) ---------- */
reg({
  id: 'SRC-15.4', family: 'SRC-15', ver: 4,
  title: 'Ferro Bloom V4', tech: 'SHADER FIELD / MOTION ILLUSION',
  ...
  draw(P, g, w, h, t, inp) {
    ...
    if (s.noGL || !P._three) {
      ...
      g.textAlign = 'center';
      g.fillText('FERRO BLOOM V4 · THE CONVERGING GARDEN', w / 2, h / 2 - 12);
