/* ---------- SRC-15.8 · FERRO BLOOM V8 (the overflow: scatter blooms flood the frame at full reach) ---------- */
reg({
  id: 'SRC-15.8', family: 'SRC-15', ver: 8,
  title: 'Ferro Bloom V8', tech: 'SHADER FIELD / MOTION ILLUSION',
  music: {
  ...
  init(P) {
    ...
    const mat = new THREE.ShaderMaterial({
      ...
      fragmentShader: [
        ...
        '    float kk = 4.0 + floor(h1 * 5.0);',
        '    float S2 = (0.050 + 0.045 * h2) * gate * (0.7 + 0.3 * sideE);',
        '    float R2 = S2 * (1.0 + 0.20 * cos(kk * th2 + sj * 2.3 + uT * (h3 - 0.5) * 0.8));',
  ...
  draw(P, g, w, h, t, inp) {
    ...
    if (s.noGL || !P._three) {
      ...
      g.textAlign = 'center';
      g.fillText('FERRO BLOOM V8 · THE OVERFLOWING GARDEN', w / 2, h / 2 - 12);
