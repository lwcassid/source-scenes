/* ---------- SRC-28.7 · CHLADNI COURT V7 ---------- */
/* V6 (mirrored kaleidoscope filling the 16:10 frame) with the field kept full
   over time: grains continuously reseed so they no longer drain into the nodal
   wells and leave the frame dark, and the grains are a touch bigger. */
reg({
  id: 'SRC-28.7', family: 'SRC-28', ver: 7, title: 'Chladni Court', tech: 'STANDING WAVES / SAND ON A PLATE',
