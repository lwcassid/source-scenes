/* ---------- SRC-13.5 · EVENT HORIZON V5 ---------- */
/* Lance's V4 verdicts: the WALL must win — in V4 the transient hits (pulse,
   announces, runs) out-shouted the sustained wall, and the gate chopped the
   bed to 15% exactly when it should be huge. Wall ~2x again, every transient
   halved, gate depth capped at 0.6. And when the rope is high the glow holds
   instead of dissipating — the space itself brightens. */
reg({
  id: 'SRC-13.5', family: 'SRC-13', ver: 5, title: 'Event Horizon', tech: 'VERLET ROPE / ACCRETION',
  music: {
