/* ---------- SRC-13.14 · EVENT HORIZON V14 — the gate holds still ---------- */
/* Lance, one note on V13: the stargate's vanishing point moved with the
   hands (it tracked the line's top). V14 pins the gate to a fixed point in
   space — frame center, 30% down — so the portal holds still and the WALL
   moves in front of it: raise the line past the gate and it silhouettes
   against the streaks, the last line of light crossing a fixed door. */
/* ---------- (V13 notes, all still in force) ---------- */
...
reg({
  id: 'SRC-13.14', family: 'SRC-13', ver: 14, title: 'Event Horizon', tech: 'VERLET ROPE / ACCRETION',
  music: {
