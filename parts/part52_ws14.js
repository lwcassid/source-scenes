/* ---------- SRC-10.14 · WEATHER STATION V14 (vast again, still one form) ---------- */
reg({
  id: 'SRC-10.14', family: 'SRC-10', ver: 15,
  title: 'Weather Station V14', tech: 'ELLIPTICAL LUMPY ORBIT / VAST + HAND-PLACED',
  music: { bpm: 60, root: 43, mode: 'aeolian', prog: [0, 5], chordBars: 4 },
  fx: { bloom: 0.7, edge: true },
  tags: ['NOT A CIRCLE', 'VAST REACH', 'LEFT HAND MOVES IT', 'WARM AT PEAK CHAOS'],
  desc: 'The rings are no longer perfect circles — each one is squashed into an ellipse, tilted like a form seen at an angle, its outline breathing with a slow shared lumpiness, so the shape reads as a volume, not a hoop. But it is a big volume now: bigger base reach, and the shared rings themselves spread wider apart, so at full gale the form sprawls across most of the sky instead of huddling in one tight knot. The left hand still carries the whole thing around a wide loop of the frame as you move your hand — where it sits, not just which way it leans, is your doing.',
  interact: 'L = heading AND placement — the wrapped form leans downwind as before, and the pole itself travels a wide loop across the sky as you move your hand, so you can park the whole object left, right, high, or low. R = the pole\'s reach: small at rest, ballooning hard as you raise the hand, until the shared elliptical rings sprawl across most of the visible sky.',
