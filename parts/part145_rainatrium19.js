/* ---------- SRC-16.19 · RAIN ATRIUM V19 (the rain survives the switch) ---
...
reg({
  id: 'SRC-16.19', family: 'SRC-16', ver: 19, title: 'Rain Atrium V19', tech: 'TWO-FIELD WATER / SUMMONED BAND',
  music: {
  ...
  audio(A, P) {
    ...
    v.fadeIn(1, 1.2);
    let nextT = 0, lastIdx = -1, sfxHeld = false, rumbleT = 0;
    return {
      tick(inp) {
        ...
        if (typeof MOut !== 'undefined') {
          ...
          if (!MOut.onModeMidi) MOut.onModeMidi = () => { sfxHeld = false; };
