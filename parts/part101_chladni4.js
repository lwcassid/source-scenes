/* ---------- SRC-28.4 · CHLADNI COURT V4 ---------- */
/* V3 with the per-panel driver circles removed and the on-lock grain swell
   pulled back — lock still reads as more size + brightness, but the grains no
   longer bloom large enough to swallow the pattern. */
reg({
  id: 'SRC-28.4', family: 'SRC-28', ver: 4, title: 'Chladni Court', tech: 'STANDING WAVES / SAND ON A PLATE',
