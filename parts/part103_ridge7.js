/* ---------- SRC-42.7 · RIDGE LOOM V7 (V6 with the stroke pulled 30% finer) ---------- */
reg({
  id: 'SRC-42.7', family: 'SRC-42', ver: 7, title: 'Ridge Loom V7', tech: 'CONTOUR HEAT / FINER STROKE, SAME LIGHT',
  music: {
  ...
  fx: { bloom: 0.45 },
  tags: ['LEFT HAND = BASS', 'RIGHT HAND = LEADS', 'HEIGHT IS THE COLOUR', 'FINE STROKE'],
  desc: 'V6 drawn with a finer pen. Everything about the light is unchanged — colour still says only how high a ridge is, deep violet (#4900ff) on the low ground and the outermost rings climbing through purple and magenta to hot orange (#f36c3b) at the summits; the open country still sits four times fainter than a summit; an almost-empty frame is still a dark frame that lifts as you fill it. What changes is the stroke: 30% thinner than V4 through V6, which is itself V3\'s thinnest weight. The packed inner rings of a whorl now read as separate lines instead of merging into a filled mass, so a summit resolves into countable rings and the whole picture moves from woven toward engraved.',
