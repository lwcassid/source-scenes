/* ---------- SRC-42.10 · RIDGE LOOM V10 (V8's palette, chosen over V9's) ---------- */
reg({
  id: 'SRC-42.10', family: 'SRC-42', ver: 10, title: 'Ridge Loom V10', tech: 'CONTOUR HEAT / TWO PALETTES, 6S BREATH',
  music: {
  ...
  desc: 'V8\'s palette, picked over V9\'s after seeing both side by side, and kept as the current version so this is what the wall opens on. Two colour states six seconds apart, running back and forth forever: violet (#4900ff) floor with orange (#f36c3b) summits, breathing into an orange floor with cyan (#00edff) summits. The endpoints travel by ROTATING hue rather than blending, which is what keeps every frame fully saturated — a straight blend from orange to cyan passes through a pale grey, and V9 showed what that costs at the halfway point. The price of rotating is that the summits pass through gold and green on their way to cyan while the floor runs up through magenta and red; that spectral sweep is the look, not a side effect. Everything else is V7: one fine stroke, height picks the hue, proximity picks the burn, an empty frame stays dark.',
