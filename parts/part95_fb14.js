/* ---------- SRC-15.14 · FERRO BLOOM V14 (randomized clusters kept, gradient flows on its own again) ---------- */
reg({
  id: 'SRC-15.14', family: 'SRC-15', ver: 14,
  title: 'Ferro Bloom V14', tech: 'SHADER FIELD / MOTION ILLUSION',
  music: {
  ...
  draw(P, g, w, h, t, inp) {
    ...
    if (s.noGL || !P._three) {
      ...
      g.textAlign = 'center';
      g.fillText('FERRO BLOOM V14 · FREE-RUNNING GRADIENT', w / 2, h / 2 - 12);
