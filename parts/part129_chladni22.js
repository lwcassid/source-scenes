/* ---------- SRC-28.22 · CHLADNI COURT V22 (the settling) ---------- */
...
reg({
  id: 'SRC-28.22', family: 'SRC-28', ver: 22, title: 'Chladni Court', tech: 'STANDING WAVES / SAND ON A PLATE',
  music: {
  ...
  init(P) {
    ...
    P.state = { grains, n, res: 0, wasLocked: false, motion: 0, lockT: -9, found: {}, appr: 0, resPrev: 0, pres: 0, tNow: 0, teaseT: 6, teaseUntil: -9, tease: 0, surgeUntil: -9, charge: 0, beatUntil: -9, beatOn: false, unlockCol: 0, beatCol: 0, beatPulse: 0, wasAwake: false, settle: 0, brLen: 5, brDepth: 1, brSkew: 0.4, gustA: 1, gustDir: 0, tollQ: false, tolled: false };
  },
  step(P, dt, t, inp) {
    const s = P.state;
    s.tNow = t;
    ...
    const reseed = dt * 0.2 * s.pres + setRe;
    let motion = 0;
    const g2 = s.grains;
    for (let i = 0; i < s.n; i++) {
