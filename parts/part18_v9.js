/* ---------- SRC-18.9 · NIGHT CIRCUIT V9 (blood dragon discipline) ---------- */
reg({
  id: 'SRC-18.9', family: 'SRC-18', ver: 9,
  title: 'Night Circuit V9', tech: 'WEBGL / DARK PALETTE / EXPRESSIVE',
  ...
  step(P, dt, t, inp) {
    ...
    T3.cam.rotation.y = 0.06; T3.cam.rotation.x = -0.115 + (act === 2 ? Math.cos(s.tunPh) * 0.035 : 0); // tunnel pitch sway
  ...
  draw(P, g, w, h, t, inp) {
    ...
    if (s.noGL || !P._three) {
      ...
      g.textAlign = 'center';
      g.fillText('NIGHT CIRCUIT V9 · THE JOURNEY', w / 2, h / 2 - 12);
