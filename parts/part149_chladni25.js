...
reg({
  id: 'SRC-28.25', family: 'SRC-28', ver: 25, title: 'Chladni Court V25', tech: 'STANDING WAVES / SAND ON A PLATE',
  music: {
      ...
      tick() {
        ...
        if (s.beatOn && T.running) {
          ...
          if (typeof MOut !== 'undefined' && typeof H !== 'undefined' && s._arpChord !== H.step) {
            ...
            MOut.evNote('arp', H.chordTone(0, 0), 0.11, 0, hold);
            MOut.evNote('arp', H.chordTone(2, 0), 0.09, 0, hold);
          }
