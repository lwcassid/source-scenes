/* ---------- SRC-42.6 · RIDGE LOOM V6 (deeper fade; an empty frame is a dark frame) ---------- */
reg({
  id: 'SRC-42.6', family: 'SRC-42', ver: 6, title: 'Ridge Loom V6', tech: 'CONTOUR HEAT / EMPTY IS DARK, FULL IS BRIGHT',
  music: {
  ...
  fx: { bloom: 0.45 },
  tags: ['LEFT HAND = BASS', 'RIGHT HAND = LEADS', 'HEIGHT IS THE COLOUR', 'FILL THE FRAME TO LIGHT IT'],
  desc: 'V5 with the fade driven much harder, and a new rule on top: how much light the frame gets at all depends on how much ridge is in it. Colour still says only how high a ridge is — deep violet (#4900ff) on the low ground and the outermost rings, climbing through purple and magenta to hot orange (#f36c3b) at the summits. But now the open country sits four times fainter than a summit rather than twice, so a whorl reads as a knot of light with real darkness around it. And an almost-empty frame is a genuinely dark frame: with both hands home there are few lines and the whole picture sinks, while a frame packed with six cores and their rings lifts to full brightness. Filling the wall is therefore something you do with your hands — reach out and the picture doesn\'t just gain rings, it gains light.',
