/* ---------- SRC-41.6 · POUR CELLS V6 (the note beats the click) ---------- */
reg({
  id: 'SRC-41.6', family: 'SRC-41', ver: 6, title: 'Pour Cells V6', tech: 'BOILING SOURCE / SINGING BURSTS',
  music: {
  ...
  fx: { bloom: 0.4 },
  tags: ['A SOURCE UNDER THE FRAME', 'L = HEAT · R = THE CHORD', 'ONE BURST, ONE NOTE', 'THE QUEUE PLAYS IN ORDER', 'IT SINGS, IT DOES NOT TICK'],
